<div class="tab-pane" id="astronomy">
	<section class="media">
		<div class="container popular-astronomy-carousel"> 
			<div id="myCarousel-popular-astronomy" class="carousel slide">
			  <!-- Carousel items -->
			  ...
			  <div class="row">
				...
				<div class="row">
			       ...
			       <div class="col-lg-3 col-md-3 col-xs-3">
				    ...
				    <!-- Carousel nav -->
			  <a class="carousel-control left" href="#myCarousel-popular-astronomy" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span> </a>
			  <a class="carousel-control right" href="#myCarousel-popular-astronomy" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span>	</a>
			</div>
