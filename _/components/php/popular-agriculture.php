<div class="tab-pane" id="agriculture">
	<section class="media">
		<div class="container popular-agriculture-carousel"> 
			<div id="myCarousel-popular-agriculture" class="carousel slide">
			  <!-- Carousel items -->
			  ...
			  <div class="row">
				...
				<div class="row">
				    ...
				    <!-- Carousel nav -->
			  <a class="carousel-control left" href="#myCarousel-popular-agriculture" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a>
			  <a class="carousel-control right" href="#myCarousel-popular-agriculture" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>	
			</div>
