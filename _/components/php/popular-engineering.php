<div class="tab-pane" id="engineering">
	<section class="media">
		<div class="container popular-engineering-carousel"> 
			<div id="myCarousel-popular-engineering2" class="carousel slide">
			  <!-- Carousel items -->
							 ...
							 <img src="images/sun1.jpg" class="image-inside-thumb" alt="My Image" />
							  <div class="caption">
							    ...
							    <div class="row glyp-modified">
							    	<div class="glyp-modified col-lg-3">
			  ...
			  <!-- Carousel nav -->
			  <a class="carousel-control left" href="#myCarousel-popular-engineering2" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a>
			  <a class="carousel-control right" href="#myCarousel-popular-engineering2" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
			</div>
