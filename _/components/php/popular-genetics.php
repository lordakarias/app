<div class="tab-pane" id="genetics">
	...
	<section class="media">
		<div class="container popular-genetics-carousel"> 
			<div id="myCarousel-popular-genetics" class="carousel slide">
			  <!-- Carousel items -->
			  ...
			  <div class="row">
				...
				<div class="row">
			       ...
			       <div class="col-lg-3 col-md-3 col-xs-3 ">
				    ...
				    <!-- Carousel nav -->
			  <a class="carousel-control left" href="#myCarousel-popular-genetics" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a>
			  <a class="carousel-control right" href="#myCarousel-popular-genetics" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>	
			</div>
